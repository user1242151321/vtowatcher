...
const FALLBACK_VERSION = "4.6.6";
const FALLBACK_DOWNLOAD = "https://raw.githubusercontent.com/user1242151321/vtowatcher/main/updates/VTO_Watcher_4.6.6.zip";
const FALLBACK_SHA = "";
...
function updateChangelog(version) {
  ...
  if (copy) copy.textContent = "V4.6.6 fixes fresh VTO cards being misclassified as filled/old and keeps the live acceptance race fix.";
}
